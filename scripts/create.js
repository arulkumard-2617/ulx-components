 ...
 * Usage: 
 *   npm run create demo-page PageName[TabMenu] --category collections --submodule menu
 *   npm run add-variation --component=TabMenu --variation=Controlled
 */
...
if (command === 'demo-page') {
  ...
  const originalScript = path.join(__dirname, '../node_modules/uls-v2/src/scripts/create-uls-app.js');
