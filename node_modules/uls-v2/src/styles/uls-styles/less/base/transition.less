...
/* Simple fade animations for PrimeReact StyleClass compatibility */
.fadein {
  display: block !important;
...
/* Duration utilities - long form for compatibility */
...
/* Iteration utilities - long form and short aliases */
