...
export default function FrozenCol() {
    ...
    const balanceTemplate = (rowData) => {
        return <span className="bold-font">{formatCurrency(rowData.balance)}</span>;
    };
    ...
    return (
        <div>
            ...
            <DataTable value={customers} scrollable scrollHeight="400px" className="mt-4">
                <Column field="name" header="Name" style={{ minWidth: '200px' }} frozen className="bold-font"></Column>
