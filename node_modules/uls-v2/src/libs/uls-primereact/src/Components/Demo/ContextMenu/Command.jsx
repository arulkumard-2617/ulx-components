...
export default function Command() {
    ...
    return (
        <div className="fxb fvc gp2">
            <ul className="mg0 pd10 list-none bd rds2 fxb column gp10 w-100p w300">
                {users.map((user) => (
                    <li
                        key={user.id}
                        className={`transparent transition-all transition-duration-200 fxb fsb ${selectedUser?.id === user.id && 'border-primary'}`}
                    ...
                    >
                        <div className="fxb fvc gp2">
                            ...
                            <span className="bold-font">{user.name}</span>
                        </div>
