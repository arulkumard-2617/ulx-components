    ...
    return (
        <div className="fxb fvc">
            <div className="fxauto">
                <label htmlFor="ssn" className="font-bold block mgb2">SSN</label>
                <InputMask id="ssn" mask="999-99-9999" placeholder="999-99-9999"></InputMask>
            </div>

            <div className="fxauto">
                <label htmlFor="phone" className="font-bold block mgb2">Phone</label>
                <InputMask id="phone" mask="(999) 999-9999" placeholder="(999) 999-9999"></InputMask>
            </div>

            <div className="fxauto">
                <label htmlFor="serial" className="font-bold block mgb2">Serial</label>
