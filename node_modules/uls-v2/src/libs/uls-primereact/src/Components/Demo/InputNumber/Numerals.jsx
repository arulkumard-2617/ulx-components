...
export default function Numerals() {
    ...
    return (
        <div className="fxb fvc gp3 wrap">
            <div>
                <label htmlFor="integeronly" className="bold-font block mgb2 font-size14">Integer Only</label>
                <InputNumber inputId="integeronly" value={value1} onValueChange={(e) => setValue1(e.value)} />
            </div>
            <div>
                <label htmlFor="withoutgrouping" className="bold-font block mgb2 font-size14">Without Grouping</label>
                <InputNumber inputId="withoutgrouping" value={value2} onValueChange={(e) => setValue2(e.value)} useGrouping={false} />
            </div>
            <div>
                <label htmlFor="minmaxfraction" className="bold-font block mgb2 font-size14">Min-Max Fraction Digits</label>
            ...
            <div>
                <label htmlFor="minmax" className="bold-font block mgb2 font-size14">Min-Max Boundaries</label>
