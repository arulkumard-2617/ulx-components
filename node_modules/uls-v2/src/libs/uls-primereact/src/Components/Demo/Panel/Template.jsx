...
export default function Template() {
    ...
    const headerTemplate = (options) => {
        const className = `uls-segment-header fsb`;
    ...
    const footerTemplate = (options) => {
        const className = `uls-segment-footer fxb wrap fvc fsb gp4`;
        ...
        return (
            <div className={className}>
                ...
                <span className="fg-text-secondary">Updated 2 hours ago</span>
            </div>
        );
    };
