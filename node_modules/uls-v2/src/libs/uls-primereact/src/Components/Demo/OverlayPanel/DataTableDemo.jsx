...
export default function DataTableDemo() {
    ...
    const selectedProductContent = selectedProduct && (
        <div className="pd10 bd1 shadow2 uls-segment w300 mgt7">
            ...
            <div className="fxb fvc gp3 mgt5">
                <span className="text-900 medium-font font-size20">{selectedProduct.name}</span>
