        ...
        <>
            <Sidebar
                ...
                content={({ closeIconRef, hide }) => (
                    <div className="min-h-100p fxb relative lg:static surface-ground">
                        <div id="app-sidebar-2" className="surface-section h-100p block flex-shrink-0 absolute lg:static left-0 top-0 z-10 bd-r1 select-none" style={{ width: '280px' }}>
                            <div className="fxc fvc h-100p">
                                <div className="fxb fvc gp2">
                                    <span className="fxb fvc gp2">
                                        ...
                                        <span className="font-semibold text-2xl fg-primary">Your Logo</span>
                                    </span>
                                    <span>
                                ...
                                <div className="overflow-y-auto">
                                    <ul className="list-none pd3 mgn0">
                                        <li>
                                            <StyleClass nodeRef={btnRef1} selector="@next" enterFromClassName="hidden" enterActiveClassName="slidedown" leaveToClassName="hidden" leaveActiveClassName="slideup">
                                                <div ref={btnRef1} className="p-ripple p-3 flex align-items-center justify-content-between text-600 pointer">
                                                    <span className="medium-font">FAVORITES</span>
                                                    <i className="pi pi-chevron-down"></i>
                                                    <Ripple />
                                                </div>
                                            </StyleClass>
                                            <ul className="list-none pd0 mgn0 overflow-hidden">
                                                <li>
                                                    <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                ...
                                                <li>
                                                    <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Bookmarks</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                                <li>
                                                    <StyleClass nodeRef={btnRef2} selector="@next" enterFromClassName="hidden" enterActiveClassName="slidedown" leaveToClassName="hidden" leaveActiveClassName="slideup">
                                                        <a ref={btnRef2} className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                            <i className="pi pi-chart-line mr-2"></i>
                                                            <span className="medium-font">Reports</span>
                                                            <i className="pi pi-chevron-down mgl-auto mgr1"></i>
                                                            <Ripple />
                                                        </a>
                                                    </StyleClass>
                                                    <ul className="list-none pd0 pdx3 mgn0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                        <li>
                                                            <StyleClass nodeRef={btnRef3} selector="@next" enterFromClassName="hidden" enterActiveClassName="slidedown" leaveToClassName="hidden" leaveActiveClassName="slideup">
                                                                <a ref={btnRef3} className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                                    <i className="pi pi-chart-line mr-2"></i>
                                                                    <span className="medium-font">Revenue</span>
                                                                    <i className="pi pi-chevron-down mgl-auto mgr1"></i>
                                                                    <Ripple />
                                                                </a>
                                                            </StyleClass>
                                                            <ul className="list-none pd0 pdx3 mgn0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                                <li>
                                                                    <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                                        ...
                                                                        <span className="medium-font">View</span>
                                                                        <Ripple />
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                                        ...
                                                                        <span className="medium-font">Search</span>
                                                                        <Ripple />
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <li>
                                                            <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                                <i className="pi pi-chart-line mr-2"></i>
                                                                <span className="medium-font">Expenses</span>
                                                                <Ripple />
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li>
                                                    <a className="p-ripple fxb fvc pd3 bd-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Team</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="p-ripple flex align-items-center pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        <i className="pi pi-comments mr-2"></i>
                                                        <span className="medium-font">Messages</span>
                                                        <span className="inline-flex align-items-center justify-content-center mgl-auto bg-blue-500 text-0 rds-circle" style={{ minWidth: '1.5rem', height: '1.5rem' }}>
                                                            3
                                                        </span>
                                                        <Ripple />
                                                    </a>
                                                ...
                                                <li>
                                                    <a className="p-ripple flex align-items-center pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Calendar</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="p-ripple flex align-items-center pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Settings</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <ul className="list-none p-3 m-0">
                                        <li>
                                            <StyleClass nodeRef={btnRef4} selector="@next" enterFromClassName="hidden" enterActiveClassName="slidedown" leaveToClassName="hidden" leaveActiveClassName="slideup">
                                                <div ref={btnRef4} className="p-ripple p-3 flex align-items-center justify-content-between text-600 pointer">
                                                    <span className="medium-font">APPLICATION</span>
                                                    <i className="pi pi-chevron-down"></i>
                                                    <Ripple />
                                                </div>
                                            </StyleClass>
                                            <ul className="list-none p-0 m-0 overflow-hidden">
                                                <li>
                                                    <a className="p-ripple flex align-items-center pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Projects</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="p-ripple flex align-items-center pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-100p">
                                                        ...
                                                        <span className="medium-font">Performance</span>
                                                        <Ripple />
                                                    </a>
                                                </li>
                                                <li>
                                ...
                                <div className="mt-auto">
                                    <hr className="mb-3 mx-3 bd-t" />
                                    <a  className="m-3 flex align-items-center pointer p-3 gp2 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                                        <Avatar image="https://primefaces.org/cdn/primereact/images/avatar/amyelsner.png" shape="circle" />
                                        <span className="bold-font">Amy Elsner</span>
                                    </a>
                                </div>
                            </div>
                        </div>
