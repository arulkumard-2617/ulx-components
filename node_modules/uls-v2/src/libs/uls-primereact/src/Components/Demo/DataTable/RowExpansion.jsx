...
export default function RowExpansion() {
    ...
    const imageBodyTemplate = (rowData) => {
        return <img src={`https://primefaces.org/cdn/primereact/images/product/${rowData.image}`} alt={rowData.image} width="64px" className="rds2 shadow-md" />;
    };
    ...
    const rowExpansionTemplate = (data) => {
        return (
            <div className="p-3">
                <h6 className='font-size16 bold-font mgb5'>Orders for {data.name}</h6>
    ...
    const header = (
        <div className="fxb wrap fve gp4 fhe">
