...
export default function Locale() {
    ...
    return (
        <div className="fxb fvc gp3 wrap">
            <div>
                <label htmlFor="locale-user" className="bold-font block mgb2 font-size14">User Locale</label>
                <InputNumber inputId="locale-user" value={value1} onValueChange={(e) => setValue1(e.value)} minFractionDigits={2} />
            </div>
            <div>
                <label htmlFor="locale-us" className="bold-font block mgb2 font-size14">United States Locale</label>
                <InputNumber inputId="locale-us" value={value2} onValueChange={(e) => setValue2(e.value)} locale="en-US" minFractionDigits={2} />
            </div>
            <div>
                <label htmlFor="locale-german" className="bold-font block mgb2 font-size14">German Locale</label>
                <InputNumber inputId="locale-german" value={value3} onValueChange={(e) => setValue3(e.value)} locale="de-DE" minFractionDigits={2} />
            </div>
            <div>
                <label htmlFor="locale-indian" className="bold-font block mgb2 font-size14">Indian Locale</label>
