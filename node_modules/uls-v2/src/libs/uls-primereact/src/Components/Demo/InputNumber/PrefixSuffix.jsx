...
export default function PrefixSuffix() {
    ...
    return (
        <div className="fxb fvc gp3 wrap">    
            <div>
                <label htmlFor="mile" className="bold-font block mgb2 font-size14">Mile</label>
                <InputNumber inputId="mile" value={value1} onValueChange={(e) => setValue1(e.value)} suffix=" mi" />
            </div>
            <div>
                <label htmlFor="percent" className="bold-font block mgb2 font-size14">Percent</label>
                <InputNumber inputId="percent" value={value2} onValueChange={(e) => setValue2(e.value)} prefix="%" />
            </div>
            <div>
                <label htmlFor="expiry" className="bold-font block mgb2 font-size14">Expiry</label>
                <InputNumber inputId="expiry" value={value3} onValueChange={(e) => setValue3(e.value)} prefix="Expires in " suffix=" days" />
            </div>
            <div>
                <label htmlFor="temperature" className="bold-font block mgb2 font-size14">Temperature</label>
