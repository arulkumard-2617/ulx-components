...
export default function Advanced() {
    ...
    const renderFooter = () => {
        ...
        return (
            <div className="custom-galleria-footer">
                <Button icon="pi pi-list" text severity=" " onClick={() => setShowThumbnails(prevState => !prevState)} />
                <Button icon={autoPlayClassName} severity=" " text onClick={() => {
                    if (!isAutoPlayActive) {
                ...
                <Button className='mgl-auto' severity=" " text icon={fullScreenClassName} onClick={() => toggleFullScreen()} />
            </div>
        );
    }
    ...
    const galleriaClassName = classNames('custom-galleria', {
        'fullscreen enter-done': isFullScreen
    });
