...
export default function AdvancedFilter() {
    ...
    const representativeFilterTemplate = (options) => {
        return <MultiSelect value={options.value} options={representatives} itemTemplate={representativesItemTemplate} onChange={(e) => options.filterCallback(e.value)} optionLabel="name" placeholder="Any" size="small" />;
    };
    ...
    const statusFilterTemplate = (options) => {
        return <Dropdown value={options.value} options={statuses} onChange={(e) => options.filterCallback(e.value, options.index)} itemTemplate={statusItemTemplate} placeholder="Select One" size="small" showClear />;
    };
    ...
    const verifiedBodyTemplate = (rowData) => {
        return <i className={`pi ${rowData.verified ? 'pi-check-circle' : 'pi-times-circle'}`}></i>;
    };

    const verifiedFilterTemplate = (options) => {
        return (
            <div className="fxb fvc gp3">
                <label htmlFor="verified-filter" className="bold-font">
                    Verified
                </label>
