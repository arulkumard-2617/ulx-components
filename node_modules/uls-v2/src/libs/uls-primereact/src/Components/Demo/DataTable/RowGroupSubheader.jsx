...
export default function RowGroupSubheader() {
    ...
    const headerTemplate = (data) => {
        return (
            <div className="fxb fvc gp2">
                <img alt={data.representative.name} src={`https://primefaces.org/cdn/primereact/images/avatar/${data.representative.image}`} width="32" className="align-middle mr2" />
                <span className="bold-font align-middle">{data.representative.name}</span>
            </div>
        );
    };
