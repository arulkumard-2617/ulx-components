...
export default function Custom() {
    ...
    const centerContent = (
        <div className="fxb wrap fvc gp5 ">
            <button className="p-link ifxb fhc fvc fg-white w40 h40 rds-circle">
                <i className="pi pi-home font-size20"></i>
            </button>
            <button className="p-link ifxb fhc fvc fg-white w40 h40 rds-circle">
                <i className="pi pi-user font-size20"></i>
            </button>
            <button className="p-link ifxb fhc fvc fg-white w40 h40 rds-circle">
                <i className="pi pi-search font-size20"></i>
            </button>
        </div>
    );
    ...
    const endContent = (
        <React.Fragment>
            <div className="fxb fvc gp4">
                <Avatar image="https://primefaces.org/cdn/primereact/images/avatar/amyelsner.png" shape="circle" />
                <span className="font-bold fg-secondary-text">Amy Elsner</span>
            </div>
        </React.Fragment>
    );

    return (
        <Toolbar start={startContent} center={centerContent} end={endContent} className="bg-gray-900 shadow-2" style={{ borderRadius: '3rem', backgroundImage: 'linear-gradient(to right, var(--primary-layer3-bg), var(--primary-layer4-bg) 40%)' }} />
    );
