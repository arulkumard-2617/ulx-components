...
export default function Group() {
    ...
    return (
        <div className="fxb fvc fhc">
            <Dropdown value={selectedCity} onChange={(e) => setSelectedCity(e.value)} options={groupedCities} optionLabel="label" 
                optionGroupLabel="label" optionGroupChildren="items" optionGroupTemplate={groupedItemTemplate} className="w-224px" placeholder="Select a City" />
        </div>
    )
}
