...
export default function RowGroupExpandable() {
    ...
    const headerTemplate = (data) => {
        return (
            <React.Fragment>
                <img alt={data.representative.name} src={`https://primefaces.org/cdn/primereact/images/avatar/${data.representative.image}`} width="32" className="align-middle mgx4" />
                <span className="align-middle bold-font">{data.representative.name}</span>
            </React.Fragment>
        );
    };
    ...
    const footerTemplate = (data) => {
        return (
            <React.Fragment>
                <td colSpan={5}>
                    <div className="fxb fhc">Total Customers: {calculateCustomerTotal(data.representative.name)}</div>
                </td>
            </React.Fragment>
        );
    };
