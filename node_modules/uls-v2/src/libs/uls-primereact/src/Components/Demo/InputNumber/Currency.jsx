...
export default function Currency() {
    ...
    return (
        <div className="fxb fvc gp3 wrap">
            <div>
                <label htmlFor="currency-us" className="font-bold block mgb2 font-size14">United States</label>
                <InputNumber inputId="currency-us" value={value1} onValueChange={(e) => setValue1(e.value)} mode="currency" currency="USD" locale="en-US" />
            </div>
            <div>
                <label htmlFor="currency-germany" className="font-bold block mgb2 font-size14">Germany</label>
            ...
            <div>
                <label htmlFor="currency-india" className="font-bold block mgb2 font-size14">India</label>
            ...
            <div>
                <label htmlFor="currency-japan" className="font-bold block mgb2 font-size14">Japan</label>
