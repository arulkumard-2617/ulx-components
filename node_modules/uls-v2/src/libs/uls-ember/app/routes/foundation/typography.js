...
export default class FoundationTypographyRoute extends Route {
  model() {
    ...
    const fontWeightRows = [
      ...
      { className: '.regular-font', property: 'font-family: @font-face-regular; font-weight: 400;' },
      { className: '.medium-font', property: 'font-family: @font-face-medium; font-weight: 500;' },
