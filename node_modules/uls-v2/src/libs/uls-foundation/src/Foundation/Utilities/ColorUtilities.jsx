...
const getColorForClass = (className) => {
  ...
  const colorMap = {
    ...
    'bg-table-header': 'var(--uls-table-list-header-bg, color-mix(in srgb, var(--layer1-bg), var(--uls-contrast-color) var(--uls-contrast-intensity-17)))',
    'bg-new-label': 'var(--new-label-bg, var(--red-bg-color, #CF1322))',
    ...
    'fg-table-header': 'var(--uls-table-list-header-fg, var(--uls-text-color))',
    ...
    'fg-new-label': 'var(--new-label-fg, var(--static-white, #fff))',
...
const backgroundUtilities = [
  ...
  {
    className: '.bg-primarylayer1',
    property: 'Primary-tinted layer 1 background.',
    color: getColorForClass('.bg-primarylayer1')
  },
  {
    className: '.bg-primarylayer2',
    property: 'Primary-tinted layer 2 background.',
    color: getColorForClass('.bg-primarylayer2')
  },
  {
    className: '.bg-primarylayer3',
    property: 'Primary-tinted layer 3 background.',
    color: getColorForClass('.bg-primarylayer3')
  },
  {
    className: '.bg-primarylayer4',
    property: 'Primary-tinted layer 4 background.',
    color: getColorForClass('.bg-primarylayer4')
  },
  {
...
const foregroundUtilities = [
  ...
  {
    className: '.fg-disable',
    property: 'Disabled element text color.',
    color: getColorForClass('.fg-disable')
  },
  {
