...
const hoverBgUtilities = [
  ...
  { className: 'hover:bg-primarylayer1', bg: '@bg-primaryLayer1' },
  { className: 'hover:bg-primarylayer2', bg: '@bg-primaryLayer2' },
  { className: 'hover:bg-primarylayer3', bg: '@bg-primaryLayer3' },
  { className: 'hover:bg-primarylayer4', bg: '@bg-primaryLayer4' },
