...
function FoundationSection({ id, title, subtitle, children }) {
  return /* @__PURE__ */ React.createElement("section", { id, className: "uls-foundation-section mgb20" }, /* @__PURE__ */ React.createElement("h3", { className: "font-bold mgt0 mgb3" }, title), /* @__PURE__ */ React.createElement("header", { className: "mgb4" }, subtitle && /* @__PURE__ */ React.createElement("p", { className: "uls-foundation-section__subtitle mgb10 font-regular fg-text-secondary mgr0" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: "uls-foundation-section__content w-100p" }, children));
}
...
function TypographyOverview() {
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement("div", { className: "uls-messages info m-size mgt10" }, keyPrinciples.map((item) => /* @__PURE__ */ React2.createElement("article", { key: item.title, className: "info uls-messages s-size enter-done mgy2", role: "alert" }, /* @__PURE__ */ React2.createElement("h5", { className: "font-bold mgt0" }, item.title), /* @__PURE__ */ React2.createElement("p", { className: "mgb0 fg-secondary font-regular" }, item.description))))
  );
}
...
function ClassPropertyTable({ rows, columnLabels = ["Class", "Properties"] }) {
  ...
  return /* @__PURE__ */ React3.createElement("div", { className: "uls-datatable s-size", style: { width: "850px" } }, /* @__PURE__ */ React3.createElement("div", { className: "datatable-wrapper" }, /* @__PURE__ */ React3.createElement("table", { className: "datatable-table", style: { tableLayout: "fixed" } }, /* @__PURE__ */ React3.createElement("thead", { className: "datatable-header" }, /* @__PURE__ */ React3.createElement("tr", { className: "datatable-header-row" }, /* @__PURE__ */ React3.createElement("th", { className: "datatable-column-header-cell" }, classLabel), /* @__PURE__ */ React3.createElement("th", { className: "datatable-column-header-cell" }, propertyLabel))), /* @__PURE__ */ React3.createElement("tbody", { className: "datatable-tbody" }, rows.map(({ className, property, color }) => /* @__PURE__ */ React3.createElement("tr", { key: className, className: "datatable-body-row" }, /* @__PURE__ */ React3.createElement("td", { className: "datatable-column-body-cell" }, /* @__PURE__ */ React3.createElement("div", { className: "fxb fvc gp3" }, color && /* @__PURE__ */ React3.createElement(
    "div",
    {
  ...
  ), /* @__PURE__ */ React3.createElement("span", { className: "font-bold fg-primary font-size16" }, formatClassName(className)))), /* @__PURE__ */ React3.createElement("td", { className: "datatable-column-body-cell" }, /* @__PURE__ */ React3.createElement("span", { className: "font-size16" }, property))))))));
}
...
function ColorsOverview() {
  return /* @__PURE__ */ React12.createElement(
    ...
    /* @__PURE__ */ React12.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr bg-layer1 mgb12" }, /* @__PURE__ */ React12.createElement("h5", { className: "font-bold mgt0 fg-primary mgb2" }, "Static palette"), /* @__PURE__ */ React12.createElement("p", { className: "fg-secondary" }, "Defined in ", /* @__PURE__ */ React12.createElement("code", null, "static-color-vars.less"), " for brand alignment.")),
    /* @__PURE__ */ React12.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr bg-layer1" }, /* @__PURE__ */ React12.createElement("h5", { className: "font-bold mgt0 fg-primary" }, "Semantic tokens"), /* @__PURE__ */ React12.createElement("p", { className: "fg-secondary" }, "Tokens like ", /* @__PURE__ */ React12.createElement("code", null, "@primary-color"), " and ", /* @__PURE__ */ React12.createElement("code", null, "@success-color"), " reference the palette."))
  );
}
...
function Theming() {
  return /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement("ol", { className: "foundation-ordered-list uls-messages info m-size mgt10" }, steps.map((step) => /* @__PURE__ */ React13.createElement("li", { key: step.title, className: "info uls-messages s-size enter-done mgy2", role: "alert" }, /* @__PURE__ */ React13.createElement("h4", { className: "mgb1" }, step.title), /* @__PURE__ */ React13.createElement("p", { className: "fg-secondary" }, step.detail))))
  );
}
...
function ColorPalette() {
  return /* @__PURE__ */ React14.createElement(
    ...
    /* @__PURE__ */ React14.createElement("div", { className: "fxb fcol gp15 w-100p" }, paletteGroups.map((group) => /* @__PURE__ */ React14.createElement("div", { key: group.title, className: "fxcol gp4" }, /* @__PURE__ */ React14.createElement("h5", { className: "mgt0 mgb4 font-bold fg-primary" }, group.title), /* @__PURE__ */ React14.createElement("div", { className: "uls-grid col-4" }, group.colors.map((color) => /* @__PURE__ */ React14.createElement("article", { key: color.token, className: "uls-foundation-card pd6 rds2 bdr flex-column md-w-1-3 text-center" }, /* @__PURE__ */ React14.createElement(
      "div",
      {
...
// src/Foundation/Colors/index.jsx
function Colors() {
  return /* @__PURE__ */ React15.createElement("div", { className: "uls-foundation-page" }, /* @__PURE__ */ React15.createElement(ColorPalette, null), /* @__PURE__ */ React15.createElement(ColorsOverview, null), /* @__PURE__ */ React15.createElement(Theming, null));
}
...
function SpacingOverview() {
  return /* @__PURE__ */ React16.createElement(
    ...
    /* @__PURE__ */ React16.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React16.createElement("h3", { className: "mgt0" }, "Design tokens"), /* @__PURE__ */ React16.createElement("p", { className: "fg-secondary" }, "@4px through @150px cover component padding, gaps, and layout spacing.")),
    /* @__PURE__ */ React16.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React16.createElement("h3", { className: "mgt0" }, "Utility classes"), /* @__PURE__ */ React16.createElement("p", { className: "fg-secondary" }, ".pd1 - .pd15, .mgx1 - .mgx15, .gp1 - .gp15 mirror the token scale."))
  );
}
...
function SpacingUtilities() {
  return /* @__PURE__ */ React18.createElement(
    ...
    utilityGroups.map((group) => /* @__PURE__ */ React18.createElement("article", { key: group.name, className: "uls-foundation-card w-30p pd6 rds2 bdr" }, /* @__PURE__ */ React18.createElement("h3", { className: "mgt0" }, group.name), /* @__PURE__ */ React18.createElement("p", { className: "fg-secondary" }, group.classes)))
  );
}

// src/Foundation/Spacing/index.jsx
function Spacing() {
  return /* @__PURE__ */ React19.createElement("div", { className: "uls-foundation-page" }, /* @__PURE__ */ React19.createElement(SpacingOverview, null), /* @__PURE__ */ React19.createElement(SpacingScale, null), /* @__PURE__ */ React19.createElement(SpacingUtilities, null));
}
...
function GridOverview() {
  return /* @__PURE__ */ React20.createElement(
    ...
    /* @__PURE__ */ React20.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React20.createElement("h3", { className: "mgt0" }, "CSS Grid"), /* @__PURE__ */ React20.createElement("p", { className: "fg-secondary" }, "`.uls-grid` handles columns, gaps, responsive breakpoints.")),
    /* @__PURE__ */ React20.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React20.createElement("h3", { className: "mgt0" }, "Flexbox"), /* @__PURE__ */ React20.createElement("p", { className: "fg-secondary" }, "`.uls-column` applies flex utilities for stacks, alignment, and spacing."))
  );
}
...
function FlexboxDocs() {
  return /* @__PURE__ */ React22.createElement(
    ...
    flexUtilities.map((utility) => /* @__PURE__ */ React22.createElement("article", { key: utility.className, className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React22.createElement("h3", { className: "mgt0" }, /* @__PURE__ */ React22.createElement("code", null, utility.className)), /* @__PURE__ */ React22.createElement("p", { className: "fg-secondary" }, utility.desc)))
  );
}

// src/Foundation/Grid/index.jsx
function Grid() {
  return /* @__PURE__ */ React23.createElement("div", { className: "uls-foundation-page" }, /* @__PURE__ */ React23.createElement(GridOverview, null), /* @__PURE__ */ React23.createElement(CSSGridDocs, null), /* @__PURE__ */ React23.createElement(FlexboxDocs, null));
}
...
function UtilitiesOverview() {
  return /* @__PURE__ */ React24.createElement(
    ...
    /* @__PURE__ */ React24.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React24.createElement("h3", { className: "mgt0" }, "Predictable naming"), /* @__PURE__ */ React24.createElement("p", { className: "fg-secondary" }, "Display (.block, .inline, .flex), spacing (.pd-, .mg-), typography (.text-).")),
    /* @__PURE__ */ React24.createElement("article", { className: "uls-foundation-card w-45p pd6 rds2 bdr" }, /* @__PURE__ */ React24.createElement("h3", { className: "mgt0" }, "Responsive variants"), /* @__PURE__ */ React24.createElement("p", { className: "fg-secondary" }, "Use prefixes such as .md-w-100 or .lg-flex for breakpoint-specific adjustments."))
  );
}
...
function PositionUtilities() {
  return /* @__PURE__ */ React26.createElement(
    ...
    /* @__PURE__ */ React26.createElement("div", { className: "fxb fcol gp10" }, /* @__PURE__ */ React26.createElement("div", null, /* @__PURE__ */ React26.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Position Types"), /* @__PURE__ */ React26.createElement(ClassPropertyTable, { rows: positionTypeUtilities })), /* @__PURE__ */ React26.createElement("div", null, /* @__PURE__ */ React26.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Top Position"), /* @__PURE__ */ React26.createElement(ClassPropertyTable, { rows: topUtilities })), /* @__PURE__ */ React26.createElement("div", null, /* @__PURE__ */ React26.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Right Position"), /* @__PURE__ */ React26.createElement(ClassPropertyTable, { rows: rightUtilities })), /* @__PURE__ */ React26.createElement("div", null, /* @__PURE__ */ React26.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Bottom Position"), /* @__PURE__ */ React26.createElement(ClassPropertyTable, { rows: bottomUtilities })), /* @__PURE__ */ React26.createElement("div", null, /* @__PURE__ */ React26.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Left Position"), /* @__PURE__ */ React26.createElement(ClassPropertyTable, { rows: leftUtilities })))
  );
}
...
function NavLinks() {
  return /* @__PURE__ */ React28.createElement(
    ...
    /* @__PURE__ */ React28.createElement("div", { className: "fxb wrap gap-lg" }, navLinkUtilities.map((item) => /* @__PURE__ */ React28.createElement("article", { key: item.className, className: "uls-foundation-card pd6 rds4 bdr w-100p md-w-1-3" }, /* @__PURE__ */ React28.createElement("p", { className: "font-semibold mgb2" }, /* @__PURE__ */ React28.createElement("code", null, item.className)), /* @__PURE__ */ React28.createElement("p", { className: "fg-text-secondary mgb0" }, item.description))))
  );
}
...
function UtilitiesNav() {
  return /* @__PURE__ */ React29.createElement("div", { className: "fxb fcol gp3 mgb12", style: { borderLeft: "1px solid var(--uls-default-border-color)", paddingLeft: "1.5rem" } }, /* @__PURE__ */ React29.createElement("div", { className: "fxb fvc gp3" }, /* @__PURE__ */ React29.createElement("span", { className: "rds4 w36 h36 fxb fvc center-all bg-layer2" }, /* @__PURE__ */ React29.createElement("i", { className: "pi pi-sliders-h", "aria-hidden": true })), /* @__PURE__ */ React29.createElement("div", { className: "fxcol" }, /* @__PURE__ */ React29.createElement("p", { className: "text-uppercase font-semibold fg-text-secondary mgb0" }, "Foundation"), /* @__PURE__ */ React29.createElement("h3", { className: "mgt0 mgb0" }, "Utilities")), /* @__PURE__ */ React29.createElement("i", { className: "pi pi-angle-up fg-text-secondary mgl-auto" })), /* @__PURE__ */ React29.createElement("nav", { className: "fxcol gp2" }, navItems.map((item) => /* @__PURE__ */ React29.createElement("a", { key: item.label, href: item.href, className: "fg-primary text-decoration-none font-semibold" }, item.label))));
}
...
function Space() {
  return /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement("div", { className: "fxb fcol gp10" }, /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - All Sides"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingAllUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Top"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingTopUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Bottom"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingBottomUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Left"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingLeftUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Right"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingRightUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Horizontal (Inline)"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingXUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Vertical (Block)"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: paddingYUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Padding - Auto"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: autoPaddingUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - All Sides"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginAllUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Top"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginTopUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Bottom"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginBottomUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Left"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginLeftUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Right"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginRightUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Horizontal (Inline)"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginXUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Vertical (Block)"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: marginYUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Negative"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: negativeMarginUtilities })), /* @__PURE__ */ React30.createElement("div", null, /* @__PURE__ */ React30.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Margin - Auto"), /* @__PURE__ */ React30.createElement(ClassPropertyTable, { rows: autoMarginUtilities })))
  );
}
...
var gridUtilities = [
  { className: ".uls-grid", property: "display: grid; 12-column template with gap: @16px and `min-width: 0`." },
  { className: ".uls-grid.compact / .comfortable", property: "gap presets (`@8px` and `@24px`)." },
  { className: ".uls-grid.auto-fit / .auto-fill", property: "responsive `repeat(auto-fit|auto-fill, minmax(250px, 1fr))` templates." },
  { className: ".uls-grid.masonry / .gallery / .dashboard", property: "pre-built layout patterns for specific use cases." },
  { className: "col-1, col-2, ... col-12", property: "Direct span helpers for children within `.uls-grid`." },
  { className: "col-lg-1, col-lg-2, ... col-lg-12", property: "Desktop overrides (\u2265 @computer-breakpoint)." },
  { className: "col-md-1, col-md-2, ... col-md-12", property: "Small computer overrides (\u2264 @largest-small-computer-screen)." },
  { className: "col-sm-1, col-sm-2, ... col-sm-12", property: "Tablet overrides (\u2264 @largest-tablet-screen)." },
  { className: "col-xs-1, col-xs-2, ... col-xs-12", property: "Mobile overrides (\u2264 @largest-mobile-screen)." },
  { className: ".uls-grid.gap-none / gap-xs / gap-sm / \u2026", property: "Gap modifiers from @8px through @32px, plus column/row gap utilities." }
];
...
function Flex() {
  return /* @__PURE__ */ React33.createElement(
    ...
    /* @__PURE__ */ React33.createElement("div", { className: "fxb fcol gp10" }, /* @__PURE__ */ React33.createElement("div", null, /* @__PURE__ */ React33.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Column Layout (.uls-column)"), /* @__PURE__ */ React33.createElement(ClassPropertyTable, { rows: columnUtilities })), /* @__PURE__ */ React33.createElement("div", null, /* @__PURE__ */ React33.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Flex Helper (.fxb)"), /* @__PURE__ */ React33.createElement(ClassPropertyTable, { rows: fxbAllUtilities })), /* @__PURE__ */ React33.createElement("div", null, /* @__PURE__ */ React33.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Shared & Item Utilities"), /* @__PURE__ */ React33.createElement(ClassPropertyTable, { rows: sharedAndItemUtilities })), /* @__PURE__ */ React33.createElement("div", null, /* @__PURE__ */ React33.createElement("h4", { className: "mgt0 mgb4 font-bold" }, "Mobile (mv) Variants"), /* @__PURE__ */ React33.createElement(ClassPropertyTable, { rows: mobileMvUtilities })))
  );
}
...
function ColorUtilities() {
  return /* @__PURE__ */ React44.createElement(
    ...
    /* @__PURE__ */ React44.createElement("div", { className: "fxb wrap gp10" }, /* @__PURE__ */ React44.createElement("div", null, /* @__PURE__ */ React44.createElement("h4", { className: "mgt0 mgb4 font-bold fg-primary" }, "Background Colors"), /* @__PURE__ */ React44.createElement(ClassPropertyTable, { rows: backgroundUtilities, columnLabels: ["Utility Class", "Description"] })), /* @__PURE__ */ React44.createElement("div", null, /* @__PURE__ */ React44.createElement("h4", { className: "mgt0 mgb4 font-bold fg-primary" }, "Foreground Colors"), /* @__PURE__ */ React44.createElement(ClassPropertyTable, { rows: foregroundUtilities, columnLabels: ["Utility Class", "Description"] })), /* @__PURE__ */ React44.createElement("div", null, /* @__PURE__ */ React44.createElement("h4", { className: "mgt0 mgb4 font-bold fg-primary" }, "Border Colors"), /* @__PURE__ */ React44.createElement(ClassPropertyTable, { rows: borderUtilities, columnLabels: ["Utility Class", "Description"] })))
  );
}
...
function BorderUtilities() {
  return /* @__PURE__ */ React47.createElement(
    ...
    /* @__PURE__ */ React47.createElement("h4", { className: "font-bold mgb5 mgt20" }, "Border Radius"),
