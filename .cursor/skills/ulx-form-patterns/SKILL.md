...
- Creating or updating a form in an Ember app
...
- `UlxForm` is the outer form container
...
1. Inspect nearby app code or demos for the established form pattern.
...
7. Localize user-facing strings when the app uses i18n.
8. Check labels, helper text, placeholders, disabled states, validation, and keyboard flow.
