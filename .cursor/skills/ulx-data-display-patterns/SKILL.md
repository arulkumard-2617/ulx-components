...
3. Look at existing demos or nearby app screens before inventing a layout.
...
- Chronological or milestone content usually fits `UlxTimeline`
- Entity identity and presence cues usually fit `UlxAvatar` or `UlxAvatarGroup`
- Standalone media presentation usually fits `UlxImage`
