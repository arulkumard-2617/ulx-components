...
const PRODUCTS = [
  { id: 1, name: 'Bamboo Watch',  category: 'Accessories', price: 65,  quantity: 24,  status: 'INSTOCK'   },
  { id: 2, name: 'Black Watch',   category: 'Accessories', price: 72,  quantity: 61,  status: 'INSTOCK'   },
  { id: 3, name: 'Blue Band',     category: 'Fitness',     price: 79,  quantity: 2,   status: 'LOWSTOCK'  },
  { id: 4, name: 'Blue T-Shirt',  category: 'Clothing',    price: 29,  quantity: 25,  status: 'INSTOCK'   },
  { id: 5, name: 'Bracelet',      category: 'Accessories', price: 15,  quantity: 73,  status: 'INSTOCK'   },
  { id: 6, name: 'Brown Purse',   category: 'Accessories', price: 120, quantity: 0,   status: 'OUTOFSTOCK'},
];
...
const ActionsCell = <template>
  <div class="fxb fvs gp2">
    ...
    <button type="button" class="uls-button text warning xs-size" aria-label="Edit {{@row.name}}">
      <i class="bs-icons1 pencil s14" aria-hidden="true"></i>
    </button>
    <button type="button" class="uls-button text danger xs-size" aria-label="Delete {{@row.name}}">
