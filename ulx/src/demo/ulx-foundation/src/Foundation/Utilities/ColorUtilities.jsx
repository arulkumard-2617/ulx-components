...
const getColorForClass = (className) => {
	...
	const colorMap = {
		...
		'bg-layer1':
			'color-mix(in srgb, var(--layer1-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-17))',
		'bg-layer2':
			'color-mix(in srgb, var(--layer2-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-layer3':
			'color-mix(in srgb, var(--layer3-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-layer4':
			'color-mix(in srgb, var(--layer4-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-layer5':
			'color-mix(in srgb, var(--layer5-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-layer6':
			'color-mix(in srgb, var(--layer6-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-primary-layer1':
			'color-mix(in srgb, var(--primary-layer1-bg), var(--ulx-primary-color) var(--ulx-contrast-intensity-17))',
		'bg-primary-layer2':
			'color-mix(in srgb, var(--primary-layer2-bg), var(--ulx-primary-color) var(--ulx-contrast-intensity-17))',
		'bg-primary-layer3':
			'color-mix(in srgb, var(--primary-layer3-bg), var(--ulx-primary-color) var(--ulx-contrast-intensity-10))',
		'bg-primary-layer4':
			'color-mix(in srgb, var(--primary-layer4-bg), var(--ulx-primary-color) var(--ulx-contrast-intensity-10))',
		'bg-primary-layerD1': 'var(--primary-layerD1-bg)',
		'bg-primary-layerD2': 'var(--primary-layerD2-bg)',
		'bg-blue-layer1':
			'color-mix(in srgb, var(--blue-layer1-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		'bg-blue-layer2':
			'color-mix(in srgb, var(--blue-layer2-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-10))',
		...
		'bg-input-disable':
			'color-mix(in srgb, var(--ulx-input-disable-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-25))',
		...
		'bg-table-header':
			'var(--ulx-table-list-head-bg, color-mix(in srgb, var(--layer1-bg), var(--ulx-contrast-color) var(--ulx-contrast-intensity-17)))',
		...
		'border-default':
			'color-mix(in srgb, var(--ulx-default-border-color), var(--ulx-contrast-color) var(--ulx-contrast-intensity-40))',
		'border-dark':
			'color-mix(in srgb, var(--ulx-dark-border-color), var(--ulx-contrast-color) var(--ulx-contrast-intensity-40))',
		'border-light':
			'color-mix(in srgb, var(--ulx-light-border-color), var(--ulx-contrast-color) var(--ulx-contrast-intensity-40))',
		'border-error': 'var(--ulx-error-border-color, #FFA39E)',
		'border-input':
			'color-mix(in srgb, var(--ulx-input-border-color), var(--ulx-contrast-color) var(--ulx-contrast-intensity-40))'
	};
