import { a as _applyDecoratedDescriptor, _ as _defineProperty, b as _initializerDefineProperty } from '../_rollupPluginBabelHelpers-CQHfKKbY.js';
 ...
 * @extends Service
 */
let AccessibilityService = (_class = class AccessibilityService extends s__default {
  constructor(...args) {
    super(...args);
    /**
    ...
    _defineProperty(this, "TEXT_SPACING", [{
      label: 'lbl.default',
      classname: '',
      value: 1
    }, {
      label: 'label.medium',
      classname: TEXT_SPACE_MEDIUM,
      value: 2
    }, {
      label: 'lbl.large',
      classname: TEXT_SPACE_LARGE,
      value: 3
    }]);
    _initializerDefineProperty(this, "propsValues", _descriptor, this);
    _initializerDefineProperty(this, "readingLineLastX", _descriptor2, this);
    _initializerDefineProperty(this, "readingLineLastY", _descriptor3, this);
    _initializerDefineProperty(this, "readingGuideLastX", _descriptor4, this);
    _initializerDefineProperty(this, "readingGuideLastY", _descriptor5, this);
  }
  ...
  createReadingGuideEle(heightValue) {
    ...
    const bottom = 100 - ((this.readingGuideLastY + clientXValue) / window.innerHeight * 100).toFixed();
    ...
    this.assignValues(this, {
      readingGuide: this._createElement({
        ...
        attributes: {
          class: this.classNames.readingGuide
        }
      }),
      topLayer: this._createElement({
        tagName: 'div',
        style: {
          height: `${divTop.toFixed()}%`
        },
        attributes: {
          class: 'top-layer'
        }
  ...
  setScrZoomVal(zoomValue) {
    ...
    body.classList.remove(`screen-zooming-size${this.accessibilityProperties.selectedScrZoomValue.toFixed().replace('.', '-')}`);
  ...
  setTextSize(textVal) {
    ...
    body.classList.remove(`${A11Y_PREFIX}global-text-size${this.accessibilityProperties.selectedTextSize.toFixed(1).replace('.', '-')}`);
  ...
  setUserA11yProps() {
    ...
    if (accessibilityProps.readingGuideValue) {
      ...
      this.initReadingGuideEvent(body, this.classNames.readingGuide, accessibilityProps.readingGuideValue);
    }
    html.classList.add(this.classNames.accFeature);
    ...
    if (accessibilityProps.selectedScrZoomValue) {
      ...
      body.classList.add(`screen-zooming-size${accessibilityProps.selectedScrZoomValue.toFixed().replace('.', '-')}`);
    }
    if (accessibilityProps.selectedTextSize) {
      ...
      body.classList.add(`${A11Y_PREFIX}global-text-size${accessibilityProps.selectedTextSize.toFixed(1).replace('.', '-')}`);
    }
  ...
  resetA11yProps(accessibilityProperties) {
    ...
    body.classList.remove(this.classNames.bigCursor, this.classNames.underlineLink, this.classNames.dyslexicFont, this.classNames.emphasizeFocus, this.classNames.criticalInfo, this.classNames.lowContrast, this.classNames.highContrast, `screen-zooming-size${accessibilityProperties.selectedScrZoomValue.toFixed().replace('.', '-')}`, `${A11Y_PREFIX}global-text-size${accessibilityProperties.selectedTextSize.toFixed(1).replace('.', '-')}`, this.classNames.toggleLabelStatus, this.classNames.textSpaceMedium, this.classNames.textSpaceLarge);
...
}, _descriptor = _applyDecoratedDescriptor(_class.prototype, "propsValues", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "readingLineLastX", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "readingLineLastY", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "readingGuideLastX", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "readingGuideLastY", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class.prototype, "setContrast", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setContrast"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setSaturationValue", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setSaturationValue"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "checkAndAddCursor", [action], Object.getOwnPropertyDescriptor(_class.prototype, "checkAndAddCursor"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setScrZoomVal", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setScrZoomVal"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "checkAndAddUnderline", [action], Object.getOwnPropertyDescriptor(_class.prototype, "checkAndAddUnderline"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "checkAndUpdateToggleStatusLabel", [action], Object.getOwnPropertyDescriptor(_class.prototype, "checkAndUpdateToggleStatusLabel"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "enableEmphasizeFocus", [action], Object.getOwnPropertyDescriptor(_class.prototype, "enableEmphasizeFocus"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setColor", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setColor"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addReadingLine", [action], Object.getOwnPropertyDescriptor(_class.prototype, "addReadingLine"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setTextSize", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setTextSize"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setTextSpacing", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setTextSpacing"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addDyslexicFont", [action], Object.getOwnPropertyDescriptor(_class.prototype, "addDyslexicFont"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addReadingGuide", [action], Object.getOwnPropertyDescriptor(_class.prototype, "addReadingGuide"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setCriticalInfo", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setCriticalInfo"), _class.prototype), _class);

export { AccessibilityService as default };
