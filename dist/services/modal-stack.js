import { a as _applyDecoratedDescriptor, b as _initializerDefineProperty, _ as _defineProperty } from '../_rollupPluginBabelHelpers-CQHfKKbY.js';
 ...
 * @extends Service
 */
let ModalStackService = (_class = class ModalStackService extends s__default {
  constructor(...args) {
    super(...args);
     ...
     * @type {number}
     */
    _defineProperty(this, "MASK_Z_INDEX", 2000);
  }
  /**
...
}, _descriptor = _applyDecoratedDescriptor(_class.prototype, "modals", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
export { ModalStackService as default };
