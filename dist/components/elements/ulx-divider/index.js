 ...
 */
let UlxDivider = (_class = (_UlxDivider = class UlxDivider extends Component {
  get layout() {
  ...
  get baseClass() {
    ...
    return this.layout === "vertical" ? getComponentClass("vtl-divider") : getComponentClass("divider");
  }
  get contentClass() {
...
}, setComponentTemplate(precompileTemplate("\n\t\t{{#let (has-block) as |hasContent|}}\n\t\t\t<div class={{buildRootClass (this.getRootClasses hasContent) hasContent}} role=\"separator\" aria-orientation={{this.ariaOrientation}} ...attributes>\n\t\t\t\t<div class={{this.contentClass}}>\n\t\t\t\t\t{{yield}}\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t{{/let}}\n\t", {
  strictMode: true,
  scope: () => ({
    buildRootClass
  })
}), _UlxDivider), _UlxDivider), _applyDecoratedDescriptor(_class.prototype, "getRootClasses", [action], Object.getOwnPropertyDescriptor(_class.prototype, "getRootClasses"), _class.prototype), _class);

export { UlxDivider as default };
