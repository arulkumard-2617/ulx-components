...
import UlxCheckboxItem from '../ulx-checkbox/checkbox-item.js';
import { precompileTemplate } from '@ember/template-compilation';
import { setComponentTemplate } from '@ember/component';

var _class, _UlxTristateCheckbox;
 ...
 */
let UlxTristateCheckbox = (_class = (_UlxTristateCheckbox = class UlxTristateCheckbox extends Component {
  get rules() {
...
}, setComponentTemplate(precompileTemplate("\n\t\t{{#if (has-block \"itemLabel\")}}\n\t\t\t<UlxCheckboxItem ...attributes @dataQa={{this.rootDataQa}} @id={{this.tristateCheckboxId}} @checked={{this.isChecked}} @indeterminate={{this.isIndeterminate}} @disabled={{@disabled}} @invalid={{this.isInvalid}} @filled={{@filled}} @size={{this.resolvedSize}} @customClass={{this.rootClasses}} @uncheckIconName={{@uncheckIconName}} @hideLabel={{@hideLabel}} @itemLabel={{@itemLabel}} @required={{this.isRequired}} @showRequiredStar={{@showRequiredStar}} @ariaDescribedBy={{@ariaDescribedBy}} @ariaErrorMessage={{@ariaErrorMessage}} @name={{@name}} @onChange={{this.handleChange}}>\n\t\t\t\t<:itemLabel>\n\t\t\t\t\t{{yield to=\"itemLabel\"}}\n\t\t\t\t</:itemLabel>\n\t\t\t</UlxCheckboxItem>\n\t\t{{else}}\n\t\t\t<UlxCheckboxItem ...attributes @dataQa={{this.rootDataQa}} @id={{this.tristateCheckboxId}} @checked={{this.isChecked}} @indeterminate={{this.isIndeterminate}} @disabled={{@disabled}} @invalid={{this.isInvalid}} @filled={{@filled}} @size={{this.resolvedSize}} @customClass={{this.rootClasses}} @uncheckIconName={{@uncheckIconName}} @hideLabel={{@hideLabel}} @itemLabel={{@itemLabel}} @required={{this.isRequired}} @showRequiredStar={{@showRequiredStar}} @ariaDescribedBy={{@ariaDescribedBy}} @ariaErrorMessage={{@ariaErrorMessage}} @name={{@name}} @onChange={{this.handleChange}} />\n\t\t{{/if}}\n\t", {
  strictMode: true,
  scope: () => ({
    UlxCheckboxItem
  })
}), _UlxTristateCheckbox), _UlxTristateCheckbox), _applyDecoratedDescriptor(_class.prototype, "handleChange", [action], Object.getOwnPropertyDescriptor(_class.prototype, "handleChange"), _class.prototype), _class);

export { UlxTristateCheckbox as default };
