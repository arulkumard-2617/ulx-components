...
import { getDestinationElement, getOverlayZIndexAboveMask } from '../../../utils/overlay-helpers.js';
...
let UlxToast = (_class = (_UlxToast = class UlxToast extends Component {
  ...
  */
  ...
  getMessageClasses(message) {
    ...
    if (message.exit || message?.id && this?.exitingIds?.has(message.id)) parts.push("toast-exit");
  ...
  */
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "exitingIds", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
