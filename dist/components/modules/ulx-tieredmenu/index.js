...
var _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor0, _descriptor1, _UlxTieredmenu;
...
const TIEREDMENU_DIRECT_LINK_SELECTOR = ":scope > li > .tieredmenu-item-link:not([aria-disabled='true'])";
/** First actionable row inside a submenu panel (after opening via keyboard). */
const TIEREDMENU_SUBMENU_FIRST_LINK_SELECTOR = ".tieredmenu-list > li > .tieredmenu-item-link:not([aria-disabled='true'])";
...
let UlxTieredmenu = (_class = (_UlxTieredmenu = class UlxTieredmenu extends Component {
  constructor(...args) {
    ...
    _initializerDefineProperty(this, "openSubmenus", _descriptor2, this);
    _initializerDefineProperty(this, "activeItemId", _descriptor3, this);
    _initializerDefineProperty(this, "focusedSubmenuId", _descriptor4, this);
    _initializerDefineProperty(this, "hoveredItemId", _descriptor5, this);
    _initializerDefineProperty(this, "hasInteracted", _descriptor6, this);
    _initializerDefineProperty(this, "animationState", _descriptor7, this);
    _initializerDefineProperty(this, "targetElement", _descriptor8, this);
    _initializerDefineProperty(this, "containerElement", _descriptor9, this);
    _initializerDefineProperty(this, "menuElement", _descriptor0, this);
    _initializerDefineProperty(this, "zIndex", _descriptor1, this);
    _defineProperty(this, "_previousVisible", false);
    _defineProperty(this, "_showEvent", null);
    /**
    * Modifier to handle container element reference and positioning
    */
    _defineProperty(this, "setContainerRef", modifier(element => {
    ...
    */
    _defineProperty(this, "setMenuRef", modifier(element => {
    ...
    */
    _defineProperty(this, "watchVisibility", modifier((element, [isVisible, isPopup, targetElement, _animationState]) => {
      if (!isPopup) return;
      ...
      if (isVisible) {
        const shouldShow = isTransitioningToVisible && !TIEREDMENU_ENTER_STATES.has(this.animationState);
        if (shouldShow) {
    ...
    */
    _defineProperty(this, "closeOnClickOutside", modifier(element => {
    ...
    */
    _defineProperty(this, "handleResize", modifier(() => {
  ...
  */
  focusFirstItemInSubmenu(triggerButton) {
    const run = () => {
      const submenuDiv = triggerButton?.nextElementSibling?.classList?.contains("tieredmenu-submenu") ? triggerButton.nextElementSibling : triggerButton?.closest("li")?.querySelector(".tieredmenu-submenu");
...
}), _UlxTieredmenu), _UlxTieredmenu), _descriptor = _applyDecoratedDescriptor(_class.prototype, "modalStack", [inject], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "openSubmenus", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "activeItemId", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "focusedSubmenuId", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "hoveredItemId", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "hasInteracted", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "animationState", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "targetElement", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "containerElement", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor0 = _applyDecoratedDescriptor(_class.prototype, "menuElement", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "zIndex", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
