...
import { scheduleOverlayInitialFocus, hasClosableToastInDom, isTopModalInstance } from '../utils/overlay-helpers.js';
 ...
 */
var overlayLifecycle = modifier((maskElement, [componentInstance, options]) => {
  const {
    onShow,
    onHide,
    onEscape,
...
export { overlayLifecycle as default };
//# sourceMappingURL=overlay-lifecycle.js.map
