...
var overlayPortal = modifier((element, [when, destination]) => {
  if (!when || !destination) return;
  let restoreContainerPosition = null;
  const isElementDestination = typeof HTMLElement !== 'undefined' && destination instanceof HTMLElement;
...
export { overlayPortal as default };
