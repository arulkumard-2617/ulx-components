...
export default function ColorsOverview() {
  return (
    ...
    >
      <article className="uls-foundation-card w-45p pd6 rds2 bdr bg-layer1 mgb12">
        <h5 className="font-bold mgt0 fg-primary mgb2">Static palette</h5>
        <p className="fg-secondary">Defined in <code>static-color-vars.less</code> for brand alignment.</p>
      </article>
      <article className="uls-foundation-card w-45p pd6 rds2 bdr bg-layer1">
        <h5 className="font-bold mgt0 fg-primary">Semantic tokens</h5>
