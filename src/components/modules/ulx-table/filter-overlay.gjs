 ...
 * @param {Object} filterMeta - current filter state for the column: { value?, matchMode?, operator?, constraints? }
...
export default class FilterOverlay extends Component {
  ...
  <template>
    <div class="ulx-datatable-filter-overlay menu-display" role="dialog" aria-label="Column filter">
