 ...
 * Renders footer cells from column `footer` text or `footerTemplate` component.
 */
export default class TableFooter extends Component {
  ...
  @action
  footerCellClass(col) {
    const parts = ['datatable-column-footer-cell'];
        ...
        <tr class="datatable-footer-row">
          {{#each @columns as |col|}}
            {{#if col.selectionMode}}
              <td class="datatable-column-footer-cell" style="width: 3rem"></td>
            {{else if col.expander}}
              <td class="datatable-column-footer-cell" style="width: 3rem"></td>
            {{else if col.rowReorder}}
              <td class="datatable-column-footer-cell" style="width: 3rem"></td>
            {{else if col.rowEditor}}
              <td class="datatable-column-footer-cell" style="width: 6rem"></td>
            {{else}}
              <td
                class={{this.footerCellClass col}}
                style={{this.footerCellStyle col}}
              >
          ...
          {{#if @showManageColumns}}
            <td class="datatable-column-footer-cell" style="width: 2.5rem"></td>
          {{/if}}
        </tr>
      </tfoot>
    {{/if}}
