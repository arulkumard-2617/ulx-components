    ...
    <thead class="datatable-thead">
      <tr class="datatable-header-row">
          ...
          {{else}}
            ...
            >
              <div class="datatable-column-header-content">
                ...
                {{#if col.sortable}}
                  <span
                    class="datatable-column-sort-icon {{this.sortIconClass (or col.sortField col.field)}}"
                    aria-hidden="true"
                  >
                ...
                {{#if (and col.filter (eq @filterDisplay "menu"))}}
                  <button
                    type="button"
                    class="datatable-filter-menu-button {{if (this.isFilterActive (or col.filterField col.field)) 'active'}}"
        ...
        {{#if @showManageColumns}}
          <th class="datatable-column-header-cell" scope="col" style="width: 2.5rem; padding: 0.5rem;">
            <UlxButton
              @variant="text"
              @icon="sliders"
