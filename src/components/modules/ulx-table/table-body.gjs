...
export default class TableBody extends Component {
  ...
  get colCount() {
    const { columns = [], showManageColumns, hasOptionCell } = this.args;
    return columns.length + (showManageColumns ? 1 : 0) + (hasOptionCell ? 1 : 0);
  }
    ...
    <tbody class="datatable-tbody">
      {{#if (and (not @loading) (eq @rows.length 0))}}
        <tr class="datatable-row">
          <td class="datatable-column-body-cell datatable-empty-message" colspan={{this.colCount}}>
          ...
          >
            {{#each @columns as |col|}}
              ...
              {{else if col.expander}}
                <td class="datatable-column-body-cell" style="width: 3rem">
                  <UlxButton
                    @variant="text"
              ...
              {{else if col.rowEditor}}
                <td class="datatable-column-body-cell" style="width: 6rem">
            ...
            {{#if @hasOptionCell}}
              <td class="datatable-column-body-cell datatable-option-cell" style="width: 6rem">
                {{yield row to="optionCell"}}
              </td>
            {{/if}}

            {{#if @showManageColumns}}
              <td class="datatable-column-body-cell" style="width: 2.5rem"></td>
            {{/if}}
          </tr>

          {{#if (this.isRowExpanded row)}}
            <tr class="datatable-row-expansion expanded">
              <td colspan={{this.colCount}} class="datatable-column-body-cell">
