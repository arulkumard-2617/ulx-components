		...
		<tbody class="datatable-tbody">
			{{#if (and (not @loading) (eq @rows.length 0))}}
				<tr class="datatable-row">
					<td class="column-body-cell datatable-empty-message" colspan={{this.colCount}}>
					...
					>
						{{#each @columns as |col|}}
							...
							{{else if col.expander}}
								<td class="column-body-cell" style="width: 3rem">
									<UlxButton
										@variant="text"
							...
							{{else if col.rowEditor}}
								<td class="column-body-cell" style="width: 6rem">
						...
						{{#if @hasOptionCell}}
							<td class="column-body-cell datatable-option-cell" style="width: 6rem">
								{{yield row to="optionCell"}}
							</td>
						{{/if}}

						{{#if @showManageColumns}}
							<td class="column-body-cell" style="width: 2.5rem"></td>
						{{/if}}
					</tr>

					{{#if (this.isRowExpanded row)}}
						<tr class="datatable-row-expansion expanded">
							<td colspan={{this.colCount}} class="column-body-cell">
