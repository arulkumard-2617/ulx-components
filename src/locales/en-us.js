...
const enUs = {
	...
	'msg.doc.fieldset.layout.grid':
		'@layout="grid" adds ulx-grid on fieldset-wrapper; use @customClass for column templates (e.g. col-2) and gap.',
	'lbl.doc.fieldset.layout.stack': 'Stack layout',
	'msg.doc.fieldset.layout.stack':
		'@layout="stack" uses flex utilities on fieldset-wrapper; add @customClass for gap utilities.',
